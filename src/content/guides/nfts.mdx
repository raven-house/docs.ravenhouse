---
title: NFTS
description: Minting and Managing NFTs
---
...
Both methods use the same ZIP file format with an images folder and metadata.json file as described in the [Collections Guide](/guides/launch-nft-collection#step-2-upload-your-nfts).
...
- Check the [wallet connection guide](/concepts/get-started)
...
- [Explore launching NFT collection](/guides/launch-nft-collection) for creators