...
By default, the **Public Minting** toggle is enabled. This setting determines the minting access for your collection:

* **When enabled**: Anyone can mint NFTs from your collection during public mint stages
* **When disabled**: Only approved wallets can mint during whitelist stages
...
- This creates a whitelist-only collection where only approved users can mint
...
- This allows you to create a collection with both whitelist and public phases
...
* **Before Stage**: Minting is disabled
* **During Stage**: Minting is active for the specified group (whitelist or public)
* **After Stage**: Minting is disabled again

You can create multiple stages to run sequentially, such as:
1. Whitelist stage (Days 1-3)
2. Public mint stage (Days 4-10)
{/* //TODO: Currently this image is wrong, please fix this, we should clearly show date in which first whitelist will be enabled then after 3 days public */}
