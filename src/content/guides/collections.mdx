...
> **Note**: After launching your collection, you'll need to add whitelist users and enable the whitelist. [Learn how to manage your whitelist →](link-to-whitelist-guide)
