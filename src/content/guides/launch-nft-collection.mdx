...
description: How to Launch a NFT Collection
---
...
Before we begin, you'll need an Aztec-compatible wallet. If you haven't set one up yet, please follow [this guide](/guides/get-started#wallet-guide) to set up your wallet.
