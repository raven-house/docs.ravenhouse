...
Raven House is a next-generation NFT infrastructure built on Aztec Network, offering privacy-focused and scalable NFT trading. Our platform empowers creators and collectors with enhanced privacy, lower fees, and advanced features.
...
- **Whitelist minting stages** – Set up exclusive minting phases with custom pricing and timing for whitelisted users  
- **Optional public minting** – Choose to allow or disable public minting after the whitelist phase, with full control over price and duration  
